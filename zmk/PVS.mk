...
static-check-pvs: $(addsuffix .PVS-Studio.log,$(PVS.Sources))
	$(call Silent.Say2,PLOG-CONVERTER,$@)
...
clean::
	$(call Silent.Say2,RM,*.i)
	$(Silent.Command)rm -f *.i
	$(call Silent.Say2,RM,*.PVS-Studio.log)
	$(Silent.Command)rm -f *.PVS-Studio.log
	$(call Silent.Say2,RM,pvs-report)
