...
all: all.log
	...
	GREP -qFx 'cc -MMD -c -o foo-foo.o $(if $(VPATH),$(VPATH)/)foo.c' <$<
	GREP -qFx 'cc -o foo foo-foo.o' <$<
	GREP -qFx 'c++ -MMD -c -o bar-bar.o $(if $(VPATH),$(VPATH)/)bar.cpp' <$<
	GREP -qFx 'c++ -MMD -o bar bar-bar.o' <$<
	GREP -qFx 'cc -MMD -c -o froz-froz.o $(if $(VPATH),$(VPATH)/)froz.m' <$<
