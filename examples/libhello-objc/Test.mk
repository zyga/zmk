...
all-other: all-other.log
	GREP -qFx 'cc -MMD -c -o libhello.a-hello.o hello.m' <$<
...
all-linux: all-linux.log
	GREP -qFx 'cc -MMD -c -o libhello.a-hello.o hello.m' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'cc -fpic -MMD -c -o libhello.so.1-hello.o hello.m' <$<
...
all-macos: all-macos.log
	GREP -qFx 'cc -MMD -c -o libhello.a-hello.o hello.m' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'cc -fpic -MMD -c -o libhello.1.dylib-hello.o hello.m' <$<
