...
all-other: all-other.log
	MATCH -qFx 'cc -MMD -c -o libhello.a-hello.o hello.c' <$<
...
all-linux: all-linux.log
	MATCH -qFx 'cc -MMD -c -o libhello.a-hello.o hello.c' <$<
	MATCH -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	MATCH -qFx 'cc -fpic -MMD -c -o libhello.so.1-hello.o hello.c' <$<
	MATCH -qFx 'cc -shared -Wl,-soname=libhello.so.1 -o libhello.so.1 libhello.so.1-hello.o' <$<
...
all-macos: all-macos.log
	MATCH -qFx 'cc -MMD -c -o libhello.a-hello.o hello.c' <$<
	MATCH -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	MATCH -qFx 'cc -fpic -MMD -c -o libhello.1.dylib-hello.o hello.c' <$<
	MATCH -qFx 'cc -dynamiclib -compatibility_version 1.0 -current_version 1.0 -o libhello.1.dylib libhello.1.dylib-hello.o' <$<
