...
all-other: all-other.log
	MATCH -qF 'cc -c -o libhello.a-hello.o hello.c' <$<
...
all-linux: all-linux.log
	MATCH -qF 'cc -c -o libhello.a-hello.o hello.c' <$<
	MATCH -qF 'ar -cr libhello.a libhello.a-hello.o' <$<
	MATCH -qF 'cc -fpic -c -o libhello.so.1-hello.o hello.c' <$<
	MATCH -qF 'cc -shared -Wl,-soname=libhello.so.1 -o libhello.so.1 libhello.so.1-hello.o' <$<
...
all-macos: all-macos.log
	MATCH -qF 'cc -c -o libhello.a-hello.o hello.c' <$<
	MATCH -qF 'ar -cr libhello.a libhello.a-hello.o' <$<
	MATCH -qF 'cc -fpic -c -o libhello.1.dylib-hello.o hello.c' <$<
	MATCH -qF 'cc -dynamiclib -compatibility_version 1.0 -current_version 1.0 -o libhello.1.dylib libhello.1.dylib-hello.o' <$<
