...
check-build-a:
	$(TEST_HEADER)
	$(MAKE) $(TEST_OPTS) all | MATCH -qF 'cc -c -o libhello.a-hello.o hello.c'
...
check-build-so:
	$(TEST_HEADER)
	$(MAKE) $(TEST_OPTS) all | MATCH -qF 'cc -fpic -c -o libhello.so.1-hello.o hello.c'
	$(MAKE) $(TEST_OPTS) all | MATCH -qF 'cc -shared -Wl,-soname=libhello.so.1 -o libhello.so.1 libhello.so.1-hello.o'
...
check-build-dylib:
	$(TEST_HEADER)
	$(MAKE) $(TEST_OPTS) all | MATCH -qF 'cc -fpic -c -o libhello.1.dylib-hello.o hello.c'
	$(MAKE) $(TEST_OPTS) all | MATCH -qF 'cc -dynamiclib -compatibility_version 1.0 -current_version 1.0 -o libhello.1.dylib libhello.1.dylib-hello.o'
