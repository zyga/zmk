...
all-linux: all-linux.log
	GREP -qFx 'c++ -MMD -c -o libhello.a-hello.o hello.cpp' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'c++ -fpic -MMD -c -o libhello.so.1-hello.o hello.cpp' <$<
...
all-macos: all-macos.log
	GREP -qFx 'c++ -MMD -c -o libhello.a-hello.o hello.cpp' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'c++ -fpic -MMD -c -o libhello.1.dylib-hello.o hello.cpp' <$<
