...
all-other: all-other.log
	GREP -qFx 'c++ -MMD -c -o libhello.a-hello.o $(ZMK.OutOfTreeSourcePath)hello.cpp' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
install-other: install-other.log
	GREP -qFx 'install -d /usr/local/include' <$<
	GREP -qFx 'install -m 0644 $(ZMK.OutOfTreeSourcePath)hello.h /usr/local/include/hello.h' <$<
...
all-linux: all-linux.log
	GREP -qFx 'c++ -MMD -c -o libhello.a-hello.o $(ZMK.OutOfTreeSourcePath)hello.cpp' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'c++ -fpic -MMD -c -o libhello.so.1-hello.o $(ZMK.OutOfTreeSourcePath)hello.cpp' <$<
...
all-macos: all-macos.log
	GREP -qFx 'c++ -MMD -c -o libhello.a-hello.o $(ZMK.OutOfTreeSourcePath)hello.cpp' <$<
	GREP -qFx 'ar -cr libhello.a libhello.a-hello.o' <$<
	GREP -qFx 'c++ -fpic -MMD -c -o libhello.1.dylib-hello.o $(ZMK.OutOfTreeSourcePath)hello.cpp' <$<
